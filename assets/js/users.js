let userDatabase = {
	"Meredith35": {image: "meredith.jpg", matches: [""], age: 62, occupation: "retired"},
	...
	"Lauren87": {image: "lauren.jpg", matches: ["Brady9"], age: 26, occupation: "Actress/Model", about: "Im pretty shy so you'll probably have to make the first move. Lets hope you wont regret it haha. L xx"},
	...
	"Kesha90": {image: "kesha.jpg", matches: ["WaveyDon100"], age: 21, occupation: "Singer/Dancer", about: "Music is my passion! Im wild and free-spirited. And will probably beat you on Fifa!! :-)"}
};
